...
# check if on v5 branch
if not "* v5" in subprocess.check_output(["git", "branch"], stdin=None, stderr=None, shell=False).decode("utf8"):
    raise Exception("Must be on v5 branch.")
